...
# def send_vacancy_application_notification_text(sender, instance, created, **kwargs):
...
# def send_vacancy_interview_notification_text(sender, instance, created, **kwargs):
