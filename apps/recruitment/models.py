...
class Interview(models.Model):
    ...
    application = models.ForeignKey(
        ...
        blank=True,
        null=True,  # For group interviews, this may be null
    )
    ...
    tpi_datetime = models.DateTimeField(
        blank=True,
        null=True,
        help_text=_("Please select a date and time at least one day in the future, excluding weekends."),
    )
    ...
    applicants = models.ManyToManyField(
        'Application',
        blank=True,
        related_name="group_interviews",
        help_text=_("Select all applicants for this group interview."),
    )
